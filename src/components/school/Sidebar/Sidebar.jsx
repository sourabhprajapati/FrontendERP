...
import { BarChart2, Coins, TicketPlus, Users, WalletCards, Ticket, ChevronRight, Circle, ChevronsRight } from "lucide-react";
...
const SIDEBAR_ITEMS = [
  { name: "Dashboard", icon: BarChart2, 
    ...
    name: "School Info",
     icon: BiSolidSchool ,
    subItems: [
      { name: "School Information" , icon: ChevronsRight},
      { name: "School Document" , icon: ChevronsRight},  
      { name: "Bank Information", icon: ChevronsRight },
]   },
      ...
      <nav className="sidebar-nav">
        {SIDEBAR_ITEMS.map((item) => (
          <div key={item.name} className="menu-item-wrapper">
            ...
            {/* Dropdown Items (removed Link, now just display text) */}
            <AnimatePresence>
